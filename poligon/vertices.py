...
def definir_vertices(lados):
    ...
    for i in range(lados):
        x = round(radio*math.cos(math.pi/180*grados)+centro[0]) #se calcula la posicion x en la pantalla sumandole el centro
        y = round(radio*math.sin(math.pi/180*grados)+centro[1])# secalcula la posicion de y en la pantalla sumandole el centro
